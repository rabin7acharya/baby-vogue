...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 30, 2023 at 05:10 PM
...
(4, 'Shirts', 'Baby Shirts for different age groups', ''),
(5, 'Jackets', 'Baby jackets to keep you warm', ''),
(6, 'Shoes', 'Baby Shoes', ''),
(7, 'Pants', 'Baby Pants', ''),
(8, 'Hats & Caps', 'Baby hats and caps', '');
