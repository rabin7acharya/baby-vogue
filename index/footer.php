...
<body>
    ...
    <div class="footer container ">
        <div class="top d-flex justify-content-between pb-2">
            <div class="left">
            <img src='/BabyVogueLogo.png' class="footer-logo">
            </div>
            <div class="right social-links d-flex gap-4">
                <!-- social links using svg -->
                <a href="https://www.facebook.com/babyvogue/" target="_blank">
                ...
                <a href="https://www.instagram.com/babyvogue/" target="_blank">
